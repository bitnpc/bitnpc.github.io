...
tags:
    ...
    - P2P
toc: true
description: '本稿では、ハードウェア設計、ソフトウェアアーキテクチャ、クラウドサービスの3つの観点から、工業レベルのMi Smart Camera（ミヤスマートカメラ）製品をどのように作るかを体系的に整理する。主に屋内PTZカメラ（パン・チルト・ズーム対応）を軸に、銃球一体型（デュアルカメラ）などの形態の違いも併せて解説する。'
---
