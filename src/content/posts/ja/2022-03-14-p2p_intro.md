...
title: 'P2P技術とその応用'
pubDate: 2022-03-14
categories: [テクノロジー, コンピュータネットワーク]
tags:
    - P2P
    - コンピュータネットワーク
toc: true
description: '一般的な動画ライブ配信は、通常 rtsp や hls プロトコルを用いて行われます。この方式では、すべてのトラフィックが中央サーバーから送出され、CDN(Content Delivery Network)を経由して各端末に配信されるという特徴があります。'
---
