...
tags:
    ...
    - Matter
toc: true
description: 'Matter は CSA（Connectivity Standards Alliance）が策定したスマートホーム相互接続プロトコルです。IP ベースのアプリケーション層プロトコルであり、異なるブランドやエコシステムのデバイスが互いに通信できないという、スマートホーム分野に長年存在する断片化問題の解決を目的としています。'
---
