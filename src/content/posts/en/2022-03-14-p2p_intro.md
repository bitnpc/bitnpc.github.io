...
tags:
    ...
    - Computer Network
toc: true
description: 'As we know, conventional live video streaming is typically delivered via RTSP or HLS protocols. The characteristic of this approach is that all traffic must originate from a central server, pass through a CDN (Content Delivery Network), and then be distributed to individual terminals.'
---
